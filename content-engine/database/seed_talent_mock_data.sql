-- Mock Data for Talent Marketplace
-- This script adds realistic sample data to demonstrate the platform

-- Insert mock talent profiles
INSERT INTO talent_profiles (
    id, user_id, display_name, bio, location, service_radius_miles, 
    hourly_rate, minimum_hours, specializations, equipment_owned, 
    years_experience, languages, availability_status, is_approved, 
...
(
    ...
    120.00,
    2,
    ARRAY['Corporate Events', 'Product Photography', 'Lifestyle', 'Portrait'],
    ARRAY['Canon EOS R5', 'Sony A7R IV', 'Professional Lighting Kit', 'Studio Setup'],
    8,
...
(
    ...
    150.00,
    3,
    ARRAY['Corporate Videos', 'Event Coverage', 'Drone Work', 'Promotional Content'],
    ARRAY['RED Komodo', 'Sony FX6', 'DJI Mavic 3', 'Gimbal Stabilizer'],
    6,
    ARRAY['English', 'Spanish', 'Malay'],
    'available',
    true,
...
(
    ...
    80.00,
    1,
    ARRAY['Social Media Content', 'Influencer Photography', 'TikTok Videos', 'Instagram Stories'],
    ARRAY['iPhone 15 Pro', 'Canon G7X Mark III', 'Ring Light', 'Portable Studio'],
    4,
    ARRAY['English', 'Thai'],
    'available',
    true,
...
(
    ...
    100.00,
    4,
    ARRAY['Wedding Photography', 'Corporate Events', 'Conferences', 'Product Launches'],
    ARRAY['Nikon D850', 'Canon 5D Mark IV', 'Multiple Lenses', 'Event Lighting'],
    10,
    ARRAY['English', 'Korean', 'Tagalog'],
    'available',
    true,
...
(
    ...
    200.00,
    2,
    ARRAY['Aerial Photography', 'Drone Videography', 'Real Estate', 'Construction Progress'],
    ARRAY['DJI Inspire 2', 'DJI Mavic 3 Pro', 'Multiple Batteries', 'ND Filters'],
    5,
...
('m2b3c4d5-e6f7-8901-bcde-f23456789012', 'b1a2b3c4-d5e6-7890-abcd-ef1234567890', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Hi! Thanks for booking. I\'ll need access to power outlets and a staging area for equipment. I\'ll arrive 1 hour early to set up.', true, NOW() - INTERVAL '2 days'),
('m3c4d5e6-f7g8-9012-cdef-345678901234', 'b2c3d4e5-f6g7-8901-bcde-f23456789012', (SELECT id FROM users WHERE email = 'shannon.green.asia@gmail.com'), 'Mike, I\'m excited about the product launch video. Can we discuss the creative direction and timeline?', false, NOW() - INTERVAL '1 day'),
